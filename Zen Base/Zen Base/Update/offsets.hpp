...
#define RELATIVE_LOCATION 0x160
...
#define PlayerCameraManager 0x //getting later
#define DEFAULTFOV 0x //getting later
#define BASEFOV 0x //getting later
