...
/*
// from github.com/KingsleydotDev/ImGuiHub
Index of this file:
// [SECTION] Header mess
...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), bool tab = false, IDirect3DTexture9* icon = nullptr);   // button
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool settings = false, IDirect3DTexture9* icon = nullptr);
